...
def convertNetwork2Graphml(startname,endname,network):
	...
	result=result+"\t"+"<key id=\"class\" for=\"node\" attr.name=\"class\" attr.type=\"string\"/>"+"\n"
	result=result+"\t"+"<key id=\"uri\" for=\"all\" attr.name=\"uri\" attr.type=\"string\"/>"+"\n"
	result=result+"\t"+"<key id=\"startnode\" for=\"node\" attr.name=\"startnode\" attr.type=\"string\"/>"+"\n"
	result=result+"\t"+"<key id=\"evidence\" for=\"node\" attr.name=\"evidence\" attr.type=\"string\"/>"+"\n"
	result=result+"\t"+"<key id=\"weight\" for=\"edge\" attr.name=\"weight\" attr.type=\"double\"/>"+"\n"
	result=result+"\t"+"<key id=\"childnodes\" for=\"node\" attr.name=\"childnodes\" attr.type=\"string\"/>"+"\n"
	result=result+"\t"+"<key id=\"nodesize\" for=\"node\" attr.name=\"nodesize\" attr.type=\"double\"/>"+"\n"
...
def generalSearchBatchCIDs(originalname, startnames, endname, op=2, maxL=3, path2 = ""):
