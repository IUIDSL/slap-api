...
def getPathScore1(weightMap, pathline, sep = " ", ntopic = 50):
	...
	result.append((weight1+weight2)/2)
	return result
...
def getPathPvalue(mypath):
	result = []
	newpath = {}
	r = robjects.r

	expectMeanTable=getPatternWeightMeanMap("Dicts/pattern_distribution.txt",sep="\t")
	expectSDTable=getPatternWeightSDMap("Dicts/pattern_distribution.txt",sep="\t")
